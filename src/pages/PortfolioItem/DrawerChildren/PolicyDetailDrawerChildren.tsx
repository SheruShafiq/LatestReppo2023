...
function PolicyDetailDrawerChildren(data: any, name: any, setOpen: any) {
  ...
  return (
    <Stack height={"100%"}>
      ...
      <Button
        ...
        onClick={() => {
          dispatch(setPolicyDetailDrawerState(!drawerState));
          setOpen(false);
        }}
      >
...
export default PolicyDetailDrawerChildren;
